...
subset to only neurons (cluster 5, res 0.1)
```{r}
merged<- subset(merged, idents = 5)
```
...
```{r, eval=F}
write.csv(CommonAnnDF,"/project2/gilad/katie/Pilot_HumanEBs/Embryoid_Body_Pilot_Workflowr/output/TranferredAnnotations_ReferenceInt_JustNeuron.csv")
```
